      ...
      <div className="flex justify-center items-center">
        <a className="p-4">
          <h3
            ...
            className="text-lg mx-auto hover:cursor-pointer hover:text-neutral-500 font-serif font-bold"
          >
            About Me »»
          </h3>
        </a>
          ...
          <div className="border border-solid border-blue-300 p-20 rounded-full">
            ...
            <div className="flex justify-center items-center gap-20 m-8">
              <a href="/ATS-CV-Arabic.pdf" download>
                <button className="bg-blue-500 text-white rounded-2xl p-4 hover:scale-90 hover:cursor-pointer hover:bg-blue-400">
                  Arabic CV
                </button>
              </a>
